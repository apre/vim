...
EX(CMD_multicursoradd,  "mca",	ex_multicursor_add,
			BANG|TRLBAR,
			ADDR_LINES),

EX(CMD_multicursorclear,  "mcc",	ex_multicursor_clear_all,
			BANG|TRLBAR,
			ADDR_LINES),
EX(CMD_multicursordel,  "mcd",	ex_multicursor_delete,
			BANG|TRLBAR,
			ADDR_LINES),
EX(CMD_multicursorstarti,  "mci",	ex_multicursor_start_interactive,
			BANG|TRLBAR,
			ADDR_LINES),
EX(CMD_multicursorstopi,  "mcs",	ex_multicursor_stop_interactive,
			BANG|TRLBAR,
			ADDR_LINES),
#endif
